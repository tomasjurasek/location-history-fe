    ...
    <HomeLayout>
        <v-container>
            ...
            <ol class="terms">
                ...
                <li>
                    <h2><span>2.</span> ZPRACOVÁNÍ OSOBNÍCH ÚDAJŮ</h2>
                    <ol>
                        <li>
                        ...
                        <li>
                            ...
                            zpracováním dat následující práva:
                            <ol>
                                <li>
                                    <span>2.6.1.</span> právo na přístup k
                                    datům, v takovém případě poskytovatel
                                    poskytne všechny informace o tom, zda jsou o
                                    uživateli zpracována data a pokud jsou tak
                                    za jakými účely, v jakém rozsahu, komu jsou
                                ...
                                <li>
                                    ...
                                    zpracování a přenositelnost;
                                </li>
                                <li>
                                    <span>2.6.4.</span> právo podat stížnost u
                                    dozorového úřadu, kterým je Úřad pro ochranu
                                    osobních údajů;
                                </li>
                            </ol>
                        </li>
                        <li>
                            <span>2.7.</span> Jednotlivá práva může uživatel
                            uplatnit prostřednictvím e-mailové adresy uvedené v
                            odst. 8.1.
                        </li>
                    </ol>
                </li>
                ...
                <li>
                    ...
                    <ol>
                        <li>
                            <span>4.1.</span> V případě jakýchkoli dotazů
                            uživatele ohledně fungování Aplikace, případně
                            hlášení výpadků Aplikace, může uživatel kontaktovat
                            poskytovatele emailem nebo telefonicky na kontakty
                            uvedené v odst. 8.1.
                        </li>
                    </ol>
                </li>
                <li>
                    <h2><span>5.</span> OMEZENÍ ODPOVĚDNOSTI POSKYTOVATELE</h2>
                    <ol>
                        <li>
                            <span>5.1.</span> Poskytovatel nenese odpovědnost za
                            žádné škody, k nimž případně dojde v důsledku poruch
                            či chyb v Aplikaci, jako je například mechanické
                            selhání, technické selhání, selhání softwaru, sítí
                            či telekomunikačních systémů nebo z důvodu přerušení
                            funkce Aplikace v důsledku výpadků elektrické
                            energie nebo přerušení či rušení telekomunikačních
                            služeb.
                        </li>
                        <li>
                            <span>5.2.</span> Poskytovatel nenese odpovědnost za
                            události vyšší moci, které mohou způsobit
                            nedostupnost Aplikace, jako například přijetí nových
                            právních předpisů, rozhodnutí vlády, přírodní
                            pohromy, stávky (včetně plánovaných stávek) či
                            výluky, vzpoury, nepokoje, sabotáž, terorismus a
                            války nebo jiné obdobné události, kterým
                            poskytovatel nemůže běžným způsobem zabránit a nad
                        ...
                        <li>
                            ...
                            s omezením odpovědnosti uvedeným v tomto článku.
                        </li>
                    </ol>
                </li>
                <li>
                ...
                <li>
                    <h2><span>7.</span> ROZHODNÉ PRÁVO A ŘEŠENÍ SPORŮ</h2>
                    <ol>
                        <li>
                            <span>7.1.</span> Veškerá práva a povinnosti
                            vyplývající z užívání Aplikace nebo v souvislosti s
                            ní nebo těmito Podmínkami se řídí českým právem.
                        </li>
                        <li>
                            <span>7.2.</span> Veškeré spory vzniklé v důsledku
                            těchto Podmínek a/nebo užívání Aplikace či v
                            souvislosti s ní budou pravomocně rozhodnuty soudy
                            České republiky.
                        </li>
                    </ol>
                </li>
                <li>
                    <h2><span>8.</span> ZÁVĚREČNÁ UJEDNÁNÍ</h2>
                    <ol>
                        <li>
